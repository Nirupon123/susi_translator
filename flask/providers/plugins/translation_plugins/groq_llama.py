"""
GroqLlamaProvider — TranslationProvider implementation using
Groq's hosted llama-3.1-8b-instant via the official groq Python SDK.

Uses a strict system prompt to ensure ONLY the translated text is returned —
no conversational filler, no markdown, suitable for direct subtitle display.

API Key masking
---------------
Same XOR-obfuscation strategy as groq_whisper.py.
"""
